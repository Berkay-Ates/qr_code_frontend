...
class AppLightThemeArgs {
  static final AppLightThemeArgs _instance = AppLightThemeArgs._init();
  static AppLightThemeArgs? get instance {
    return _instance;
  }

  AppLightThemeArgs._init();
  ...
  final Color SUGAR_MILK = const Color(0xffF5F5F5);
  final Color LAPIS_ON_NEPTUN = const Color(0xff6331DD);
  ...
  final Color lightGray = const Color(0xfff9f9f9);
